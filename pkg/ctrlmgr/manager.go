...
import (
	...
	"github.com/saashqdev/kubeworkz/pkg/ctrlmgr/controllers"
	"github.com/saashqdev/kubeworkz/pkg/ctrlmgr/options"
	"github.com/saashqdev/kubeworkz/pkg/ctrlmgr/webhooks"
...
func (m *ControllerManager) Run(stop <-chan struct{}) {
	...
	defer func() {
		clog.Info("kubeworkz won the leader")
		cancel()
	}()
	...
	case <-ticker.C:
		...
		// need cluster sync
		clog.Info("kubeworkz run as subsidiary")
