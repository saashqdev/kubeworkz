...
//+kubebuilder:rbac:groups=tenant.kubeworkz.io,resources=projects,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=tenant.kubeworkz.io,resources=projects/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=tenant.kubeworkz.io,resources=projects/finalizers,verbs=update
...
func (r *ProjectReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	// according to kubeworkz.io/tenant label get user
	labels := project.ObjectMeta.Labels
	tenantName, ok := labels[constants.TenantLabel]
	if !ok {
		log.Error("this project do not content tenant label .metadata.labels.kubeworkz.io/tenant")
