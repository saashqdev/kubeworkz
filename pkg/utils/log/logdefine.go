...
// NOTE: This file is copied from k8s.io/kubernetes/dashboard/src/app/backend/resource/logs/logs.go.
// We have expanded some attributes, such as MaxLogLines and LineReadLimit.
