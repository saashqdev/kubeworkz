...
import (
	...
	"github.com/saashqdev/kubeworkz/pkg/utils/audit"
	...
	"github.com/saashqdev/kubeworkz/pkg/utils/md5util"
...
// @Success 200 {object} response.SuccessInfo
// @Failure 500 {object} errcode.ErrorInfo
// @Router /api/v1/kube/user/:username [put]
...
// @Router /api/v1/kube/user/template  [get]
...
// @Success 200 {object} response.SuccessInfo
// @Failure 500 {object} errcode.ErrorInfo
// @Router /api/v1/kube/user/users [post]
...
// @Success 200 string string
// @Failure 500 {object} errcode.ErrorInfo
// @Router /api/v1/kube/user/kubeconfigs [get]
...
// @Failure 500 {object} errcode.ErrorInfo
// @Router /api/v1/kube/user/:username [get]
...
// @Success 200 {object} response.SuccessInfo
// @Failure 500 {object} errcode.ErrorInfo
// @Router /api/v1/kube/user/pwd [put]
