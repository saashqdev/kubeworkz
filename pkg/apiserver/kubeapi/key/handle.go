...
import (
	...
	key "github.com/saashqdev/kubeworkz/pkg/apis/user/v1"
...
// @Router /api/v1/kube/key/create  [get]
...
// @Failure 500 {object} errcode.ErrorInfo
// @Router /api/v1/kube/key/token  [get]
