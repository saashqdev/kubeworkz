...
import (
	...
	"github.com/saashqdev/kubeworkz/pkg/utils/access"
...
// @Failure 500 {object} errcode.ErrorInfo
// @Router /api/v1/kube/clusters/namespaces  [get]
...
// @Failure 500 {object} errcode.ErrorInfo
// @Router /api/v1/kube/clusters/resources  [get]
...
// @Success 200 {object} map[string]interface{} "{"items":[{"namespace":"ns-3","cluster":"member-1","project":"project-2","namespaceBody":{"metadata":{"name":"ns-3","uid":"8b557f42-dcda-4555-bfba-4bc448b4d66f","resourceVersion":"862129","creationTimestamp":"2022-04-28T08:18:35Z","labels":{"hnc.x-k8s.io/included-namespace":"true","kubeworkz-project-project-2.tree.hnc.x-k8s.io/depth":"1","kubeworkz-tenant-tenant-2.tree.hnc.x-k8s.io/depth":"2","kubeworkz.hnc.x-k8s.io/project":"project-2","kubeworkz.hnc.x-k8s.io/tenant":"tenant-2","kubernetes.io/metadata.name":"ns-3","ns-3.tree.hnc.x-k8s.io/depth":"0"},"annotations":{"hnc.x-k8s.io/subnamespace-of":"kubeworkz-project-project-2"},"managedFields":[{"manager":"manager","operation":"Update","apiVersion":"v1","time":"2022-05-06T03:33:37Z","fieldsType":"FieldsV1","fieldsV1":{"f:metadata":{"f:annotations":{".":{},"f:hnc.x-k8s.io/subnamespace-of":{}},"f:labels":{".":{},"f:kubeworkz-project-project-2.tree.hnc.x-k8s.io/depth":{},"f:kubeworkz-tenant-tenant-2.tree.hnc.x-k8s.io/depth":{},"f:kubeworkz.hnc.x-k8s.io/project":{},"f:kubeworkz.hnc.x-k8s.io/tenant":{},"f:kubernetes.io/metadata.name":{},"f:ns-3.tree.hnc.x-k8s.io/depth":{}}}}}]},"spec":{"finalizers":["kubernetes"]},"status":{"phase":"Active"}}},{"namespace":"ns-2","cluster":"member-2","project":"project-2","namespaceBody":{"metadata":{"name":"ns-2","uid":"8924ca69-c309-4e94-a55b-893b21ffde17","resourceVersion":"2270","creationTimestamp":"2022-04-28T08:18:23Z","labels":{"hnc.x-k8s.io/included-namespace":"true","kubeworkz-project-project-2.tree.hnc.x-k8s.io/depth":"1","kubeworkz-tenant-tenant-2.tree.hnc.x-k8s.io/depth":"2","kubeworkz.hnc.x-k8s.io/project":"project-2","kubeworkz.hnc.x-k8s.io/tenant":"tenant-2","kubernetes.io/metadata.name":"ns-2","ns-2.tree.hnc.x-k8s.io/depth":"0"},"annotations":{"hnc.x-k8s.io/subnamespace-of":"kubeworkz-project-project-2"},"managedFields":[{"manager":"manager","operation":"Update","apiVersion":"v1","time":"2022-04-28T08:18:23Z","fieldsType":"FieldsV1","fieldsV1":{"f:metadata":{"f:annotations":{".":{},"f:hnc.x-k8s.io/subnamespace-of":{}},"f:labels":{".":{},"f:kubeworkz-project-project-2.tree.hnc.x-k8s.io/depth":{},"f:kubeworkz-tenant-tenant-2.tree.hnc.x-k8s.io/depth":{},"f:kubeworkz.hnc.x-k8s.io/project":{},"f:kubeworkz.hnc.x-k8s.io/tenant":{},"f:kubernetes.io/metadata.name":{},"f:ns-2.tree.hnc.x-k8s.io/depth":{}}}}}]},"spec":{"finalizers":["kubernetes"]},"status":{"phase":"Active"}}}],"total":2}"
// @Failure 500 {object} errcode.ErrorInfo
// @Router /api/v1/kube/clusters/subnamespaces  [get]
func (h *handler) getSubNamespaces(c *gin.Context) {
	...
	for _, cluster := range clusters {
		...
		for _, ns := range nsList.Items {
			...
			// filter project ns(such as kubeworkz-project-project-1).
...
// @Failure 500 {object} errcode.ErrorInfo
// @Router /api/v1/kube/clusters/addCluster  [post]
...
// @Failure 400 {object} errcode.ErrorInfo
// @Failure 500 {object} errcode.ErrorInfo
// @Router /api/v1/kube/clusters/nsquota  [post]
...
type kubeResourceQuotaData struct {
	ClusterName       string                     `json:"clusterName"`
