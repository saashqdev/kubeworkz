...
var doc = `{
    ...
    "basePath": "{{.BasePath}}",
    "paths": {
        "/api/v1/kube/authorization/bindings": {
            "post": {
        ...
        "/api/v1/kube/authorization/clusterroles": {
            "get": {
        ...
        "/api/v1/kube/authorization/identities": {
            "get": {
        ...
        "/api/v1/kube/authorization/projects": {
            "get": {
        ...
        "/api/v1/kube/authorization/roles": {
            "get": {
        ...
        "/api/v1/kube/authorization/tenants": {
            "get": {
        ...
        "/api/v1/kube/authorization/users": {
            "get": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/pkg_apiserver_kubeapi_cluster.scriptData"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/kube/clusters/namespaces": {
            "get": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/pkg_apiserver_kubeapi_cluster.nsAndQuota"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/kube/clusters/resources": {
            "get": {
        ...
        "/api/v1/kube/clusters/subnamespaces": {
            "get": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github.com_saashqdev_kubeworkz_pkg_apiserver_kubeapi_user.LoginInfo"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github.com_saashqdev_kubeworkz_pkg_apiserver_kubeapi_user.UserList"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github.com_saashqdev_kubeworkz_pkg_apiserver_kubeapi_user.NameValid"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github.com_saashqdev_kubeworkz_pkg_apiserver_kubeapi_user.ResetPwd"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "github.com_saashqdev_kubeworkz_pkg_apiserver_kubeapi_authorization.result": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "object"
        ...
        "github.com_saashqdev_kubeworkz_pkg_apiserver_kubeapi_cluster.clusterInfo": {
            "type": "object",
            "properties": {
                "clusterDescription": {
                    "type": "string"
        ...
        "github.com_saashqdev_kubeworkz_pkg_apiserver_kubeapi_cluster.nsAndQuota": {
            "type": "object",
            "properties": {
                "cluster": {
                    "type": "string"
        ...
        "github.com_saashqdev_kubeworkz_pkg_apiserver_kubeapi_cluster.result": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github.com_saashqdev_kubeworkz_pkg_apiserver_kubeapi_cluster.clusterInfo"
                    }
                },
                "total": {
                    "type": "integer"
        ...
        "github.com_saashqdev_kubeworkz_pkg_apiserver_kubeapi_cluster.scriptData": {
            "type": "object",
            "properties": {
                "clusterName": {
                    "type": "string"
        ...
        "github.com_saashqdev_kubeworkz_pkg_apiserver_kubeapi_user.LoginInfo": {
            "type": "object",
            "properties": {
                "loginType": {
                    "type": "string"
        ...
        "github.com_saashqdev_kubeworkz_pkg_apiserver_kubeapi_user.NameValid": {
            "type": "object",
            "properties": {
                "isValid": {
                    "type": "boolean"
        ...
        "github.com_saashqdev_kubeworkz_pkg_apiserver_kubeapi_user.ResetPwd": {
            "type": "object",
            "properties": {
                "newPassword": {
                    "type": "string"
        ...
        "github.com_saashqdev_kubeworkz_pkg_apiserver_kubeapi_user.UserItem": {
            "type": "object",
            "properties": {
                "name": {
                    "type": "string"
        ...
        "github.com_saashqdev_kubeworkz_pkg_apiserver_kubeapi_user.UserList": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github.com_saashqdev_kubeworkz_pkg_apiserver_kubeapi_user.UserItem"
                    }
                },
                "total": {
                    "type": "integer"
        ...
        "pkg_apiserver_kubeapi_authorization.result": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "object"
        ...
        "pkg_apiserver_kubeapi_cluster.clusterInfo": {
            "type": "object",
            "properties": {
                "clusterDescription": {
                    "type": "string"
        ...
        "pkg_apiserver_kubeapi_cluster.nsAndQuota": {
            "type": "object",
            "properties": {
                "cluster": {
                    "type": "string"
        ...
        "pkg_apiserver_kubeapi_cluster.result": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/pkg_apiserver_kubeapi_cluster.clusterInfo"
                    }
                },
                "total": {
                    "type": "integer"
        ...
        "pkg_apiserver_kubeapi_cluster.scriptData": {
            "type": "object",
            "properties": {
                "clusterName": {
                    "type": "string"
        ...
        "pkg_apiserver_kubeapi_user.LoginInfo": {
            "type": "object",
            "properties": {
                "loginType": {
                    "type": "string"
        ...
        "pkg_apiserver_kubeapi_user.NameValid": {
            "type": "object",
            "properties": {
                "isValid": {
                    "type": "boolean"
        ...
        "pkg_apiserver_kubeapi_user.ResetPwd": {
            "type": "object",
            "properties": {
                "newPassword": {
                    "type": "string"
        ...
        "pkg_apiserver_kubeapi_user.UserItem": {
            "type": "object",
            "properties": {
                "name": {
                    "type": "string"
        ...
        "pkg_apiserver_kubeapi_user.UserList": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/pkg_apiserver_kubeapi_user.UserItem"
                    }
                },
                "total": {
                    "type": "integer"
